...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean mainEntityManagerFactory() {
        ...
        mainFactoryBean.setPackagesToScan("com.module.batch.entity");
    ...
    public LocalContainerEntityManagerFactoryBean dormantEntityManagerFactory() {
        ...
        dormantFactoryBean.setPackagesToScan("com.module.batch.dormant.entity");
    ...
    @EnableJpaRepositories(
            basePackages = "com.module.batch.repository",
    ...
    @Configuration
    @EnableJpaRepositories(
            basePackages = "com.module.batch.dormant.repository",
